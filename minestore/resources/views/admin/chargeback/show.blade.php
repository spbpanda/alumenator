				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-5 mb-2 d-flex justify-content-start">
							<a href="{{ route('chargeback.index') }}" class="btn btn-primary" style="margin-right: 5px;">
								<span class="tf-icons bx bx-arrow-back me-1"></span>{{ __('Back') }}
							</a>
							<a href="{{ route('chargeback.download', $chargeback->id) }}" target="_blank" class="btn btn-warning">
								<span class="tf-icons bx bxs-download me-1"></span>{{ __('Generate Evidence (PDF)') }}
							</a>
						</div>
                        @if($chargeback->payment->gateway != 'Stripe')
						<div class="col-md-7 mb-2 d-flex justify-content-end">
							<button type="button" class="btn btn-success" id="submit-button">
								<span class="tf-icons bx bxs-check-shield me-1"></span>{{ __('Submit to Stripe') }}
							</button>
						</div>
                        @endif
					</div>
							  ...
							  <tbody>
								...
								<tr>
								  ...
								  <td>
									...
									<img  width="20" height="20" src="https://minotar.net/avatar/{{ $username }}/25" alt="{{ $username }}"> {{ $username }}
								  </td>
								</tr>
								<tr>
								  <td style="font-weight: 500;">
	...
	<div class="col-md-12 mb-4">
		...
		<hr>
			<div class="card-body text-center">
				<img src="https://mc-heads.net/body/{{ $chargeback->payment->user->uuid }}" alt="{{ $username }}" style="width: 140px; border-radius: 4px;transform: scale(-1, 1); margin-bottom: 5px;">
				...
				<div class="row">
					  ...
					  <div class="col-6 col-md-6">
                          <a href="{{ route('lookup.search', $username) }}" target="_blank" class="btn btn-lg btn-warning">
