...
@section('page-script')
    <script>
        function setPaynowCookie(interested) {
            const farFuture = new Date();
            farFuture.setFullYear(farFuture.getFullYear() + 10);

            document.cookie = "paynow_interest=" + interested + "; expires=" + farFuture.toUTCString() + "; path=/";
        }
    </script>
@endsection
...
@section('content')
        ...
        <div class="col-12">
            <div class="card h-100">
                ...
                <div class="card-body d-flex flex-column">
                    <h4 class="card-title text-center mb-4">Seamless Integration of PayNow & MineStoreCMS</h4>
    ...
    <div class="row mt-4">
        <div class="col-12 text-center">
            <a href="{{ route('paynow.onboarding.start') }}" class="btn btn-primary btn-lg w-100 mb-3" onclick="setPaynowCookie(true)">
                <i class="bx bx-rocket me-2"></i> Get Started with <strong>PayNow Checkout</strong>
            </a>
            <a href="{{ route('settings.merchant') }}" class="btn btn-secondary btn-lg w-100" onclick="setPaynowCookie(false)">
                <i class="bx bx-cog me-2"></i> Configure Other Payment Gateways Available in <strong>MineStoreCMS</strong> (Self-Controlled Payment Methods)
            </a>
        </div>
    </div>
@endsection
