...
<form action="{{ route('pages.create') }}" method="POST" autocomplete="off">
@csrf
<h4 class="fw-bold py-3 mb-1">
  <span class="text-body fw-light">{{ __('New Page') }}</span>
</h4>
      ...
      <div class="row">
        <div class="col-md-12 mb-2">
          <div class="col-md-12">
              ...
              <input type="text" class="form-control" id="name" name="name" placeholder="Terms Of Service" required />
                  @error('name')
          ...
          <div class="col-md-12 mb-3">
            <label for="full-editor" class="form-label">
              ...
              <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="tos" id="url" name="url" value="">
              </div>
              @error('url')
                <span class="text-danger">{{ $message }}</span>
              @enderror
...
<div class="row">
  <div class="d-grid gap-2 col-lg-12 mx-auto">
    <button class="btn btn-primary btn-lg"><span class="tf-icon bx bx-plus-circle bx-xs"></span> {{ __('Create Page') }}</button>
  </div>
</div>
</form>
