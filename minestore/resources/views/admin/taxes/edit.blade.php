...
<h4 class="fw-bold py-3 mb-1">
  <span class="text-body fw-light">{{ __('Edit Tax') }}</span>
</h4>
      ...
      <div class="row">
        <div class="col-md-12 mb-2">
          <div class="col-md-12">
              ...
              <input type="text" class="form-control" id="name" name="name" value="{{ $tax->name }}" placeholder="Spain's VAT" required />
                  @error('name')
          ...
          <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <select id="country" name="country" class="select2 form-select">
                    ...
                    <option value="{{ $language_code }}" {{ $tax->country == $language_code ? 'selected' : '' }}>@if(__($language_name) != $language_name) @lang($language_name) / @endif {{ $language_name }}</option>
                    @endforeach
                </select>
                  @error('country')
                    <span class="text-danger">{{ $message }}</span>
              ...
              <div class="col-md-6 mb-3">
                  ...
                  <div class="input-group mb-2">
                    <input type="text" inputmode="decimal" pattern="^\d*([,.]\d{1,2})?$" id="percent" name="percent" value="{{ $tax->percent }}" class="form-control" placeholder="10">
            ...
            <div class="col-md-12">
              <div class="bg-lighter border rounded p-3 mb-3">
                <label class="switch switch-square" for="is_included">
                  <input type="checkbox" id="is_included" name="is_included" {{ $tax->is_included == 1 ? 'checked' : '' }} class="switch-input" />
...
<div class="row">
  <div class="d-grid gap-2 col-lg-12 mx-auto">
    <button class="btn btn-primary btn-lg" type="submit"><span class="tf-icon bx bx-plus-circle bx-xs"></span> {{ __('Update the Tax') }}</button>
  </div>
</div>
</form>
