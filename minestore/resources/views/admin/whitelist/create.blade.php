...
<h4 class="fw-bold py-3 mb-1">
  <span class="text-body fw-light">{!! __('Whitelist username or a customer\'s IP') !!}</span>
</h4>
            ...
            <div class="col-md-12">
                <label for="reason" class="form-label">
                    ...
                    <i class="bx bx-help-circle text-muted" style="margin-bottom: 1px;"
                       ...
                       title="{{ __('Enter a reason for whitelist.') }}"></i>
                </label>
...
<div class="row">
	<div class="d-grid gap-2 col-lg-12 mx-auto">
        <button class="btn btn-primary btn-lg" type="submit"><span class="tf-icon bx bx-plus-circle bx-xs"></span> {{ __('Whitelist this User') }}</button>
    </div>
</div>
</form>
@endsection
