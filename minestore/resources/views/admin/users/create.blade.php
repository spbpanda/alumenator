...
<h4 class="fw-bold py-3 mb-1">
  <span class="text-body fw-light">{{ __('Add a New Team Account') }}</span>
</h4>
		...
		<div class="card">
			<div class="card-body">
				<div class="mb-3">
				  ...
				  <input type="text" autocomplete="false" class="form-control" id="username" name="username" placeholder="admin" />
                    @error('username')
				...
				<div class="row d-flex w-100 align-self-center">
					...
					<div class="action col-12 col-xl-3 col-lg-4 align-self-center text-center mx-auto d-grid">
						<label class="switch switch-square" for="is_admin">
						  <input type="checkbox" class="switch-input" id="is_admin" onclick="makeAdmin(event)" />
					...
					@for($i = 0; $i < count($rules); $i++)
					  <tr>
						...
						<td>
							<div class="d-flex justify-content-center">
								<label class="orange-checkbox-container">
								  <input type="checkbox" class="ruleCheckbox" name="{{$rules[$i][1]}}[read]" >
						...
						<td>
							<div class="d-flex justify-content-center">
								<label class="orange-checkbox-container">
								  <input type="checkbox" class="ruleCheckbox" name="{{$rules[$i][1]}}[write]">
								  <span class="checkmark"></span>
								</label>
							</div>
						</td>
						<td>
							<div class="d-flex justify-content-center">
								<label class="orange-checkbox-container">
								  <input type="checkbox" class="ruleCheckbox" name="{{$rules[$i][1]}}[del]">
								  <span class="checkmark"></span>
								</label>
							</div>
						</td>
...
<div class="row mb-4">
	<div class="d-grid gap-2 col-lg-12 mx-auto">
       <button class="btn btn-primary btn-lg" type="submit"><span class="tf-icon bx bx-plus-circle bx-xs"></span> {{ __('Create a New Account') }}</button>
    </div>
</div>
</form>
