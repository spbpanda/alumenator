...
class TaxesController extends Controller
{
    ...
    {
        $this->setTitle(__('Taxes'));
    }

    public function index(): View|RedirectResponse
    {
        if (!UsersController::hasRule('taxes', 'read')) {
    ...
    {
        if (!UsersController::hasRule('taxes', 'write')) {
            return redirect('/admin');
        }
    ...
    public function store(StoreTaxRequest $request): RedirectResponse
    {
        ...
        SecurityLog::create([
            ...
            'action' => SecurityLog::ACTION['taxes'],
            'action_id' => $tax->id,
        ]);
    ...
    public function update(UpdateTaxRequest $request, string $id): RedirectResponse
    {
        ...
        Tax::where('id', $id)->update($request->validated());
    ...
    {
        if (!UsersController::hasRule('taxes', 'del')) {
            return redirect('/admin');
        }
