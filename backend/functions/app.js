...
app.get('/goods', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (searchQuery) {
            allGoods = allGoods.filter((good) => good.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
...
app.post('/create-payment', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const response = yield axios_1.default.post('https://easydonate.ru/api/v3/shop/payment/create', {
